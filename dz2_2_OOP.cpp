...
изменения возраста и веса. Создать производный класс Student (студент),
...
int main()
{
    ...
    do {
        ...
        Person human1;
        cout << "Введите имя, возраст и вес класса Person: " << endl;
        string n;
        int a;
        int w;
        cin >> n >> a >> w;
        ...
        human1.PrintInfo();
        Student student1;
        cout << "Введите имя, возраст, вес и год обучения класса Student: " << endl;
        int y;
        cin >> n >> a >> w >> y;
        student1.setName(n);
        student1.setAge(a);
